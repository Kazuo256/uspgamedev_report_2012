...
\section{\LARGE O que é o USPGameDev?}
    ...
    \subsection{Atividades}
        ...
        \begin{itemize}
        \item {\bf CMake} - gerenciador de compilação de projetos de software multiplataforma;
        \item {\bf Lua} - linguagem de script brasileira muito usada por jogos de renome no mercado; e
        \item {\bf LÖVE} - uma plataforma para desenvolvimento de jogos em duas dimensões minimal e
              gratuita.
        \end{itemize}
        ...
        \begin{itemize}
        \item {\bf Git} - ferramenta de controle de versão de projetos;
        \item {\bf \LaTeX} - programa de formatação de texto muito utilizado no mundo acadêmico; e
        \item {\bf SSH} - protocolo de rede que permite conexões seguras entre computadores.
        \end{itemize}
    ...
    \subsection{Metodologia}
        ...
        monografia resultante de trabalho, que pode ser encontrada em:
