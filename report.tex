...
\section{\LARGE Projetos}
    ...
    para problemas que já ocorreram anteriormente, tornando o processo dedesenvolvimento mais
    ...
    \label{sec:horus}
        ...
        \footnotetext{Mais informações: \url{http://en.wikipedia.org/wiki/C++}}
        DirectMedia Layer\footnotemark (SDL), versão 1.2, que fornece as funcionalidades gráficas e
        \footnotetext{Site oficial: \url{www.libsdl.org}}
        ...
        \footnotetext{Site oficial: \url{www.opengl.org}}
        ...
        estáveis) e em desenvolvimento (instáveis), podem ser encontradas no site oficial do
        USPGameDev.
    ...
    \subsection{UGDK}
        ...
        funcionalidades conveniente de C++, usa-se a biblioteca Boost\footnotemark (em particular o
        \footnotetext{Site oficial: \url{www.boost.org}}
        pacote TR1\footnotemark). Para poder acoplar módulos em outras linguagens além do C+ aos
        \footnotetext{Mais informações
                      \url{http://en.wikipedia.org/wiki/C++\_Technical\_Report\_1}}
        jogos que são desenvolvidos usando a \textbf{UGDK}, foi usado um programa chamado
        SWIG\footnotemark, que faz justamente isso. Graças a isso, o projeto está sendo estendido
        \footnotetext{Site oficial: \url{www.swig.org}}
        para ser compatível com as linguagens Lua e Python\footnotemark. Por serem bem mais fáceis
        \footnotetext{Site oficial: \url{www.python.org}}
        ...
        das versões de lançamento (estáveis) e quanto as em desenvolvimento (instáveis), podem ser        
    ...
    \label{sec:pirates}
        ...
        \footnotetext{Site oficial: \url{www.panda3d.org}}
